...
const MOBILE_DESC_WORDS = 50;   // ✅ requested
const DESKTOP_DESC_WORDS = 100; // ✅ requested
...
// Tailwind "sm" breakpoint is 640px, so mobile = max-width: 639px
const useIsMobile = () => {
...
function MovieInfo({ movie, setModalOpen, DownloadVideo, onBackClick }) {
  ...
  // ✅ NEW: responsive word limit + expand/collapse
  ...
  const descToShow = descExpanded || !isTruncated ? movie?.desc || '' : collapsedDesc;
        ...
        <div className="container px-8 mobile:px-4 mx-auto 2xl:px-32 xl:grid grid-cols-3 flex-colo py-10 lg:py-20 gap-8">
          ...
          <div className="mt-2 col-span-2 md:grid grid-cols-5 gap-4 items-center">
            <div className="col-span-3 flex flex-col gap-10 above-1000:gap-6">
              ...
              {/* ✅ NEW: Description (50 words mobile, 100 words desktop) */}
