...
export const MOVIE_BROWSEBY_REQUEST = "MOVIE_BROWSEBY_REQUEST";
export const MOVIE_BROWSEBY_SUCCESS = "MOVIE_BROWSEBY_SUCCESS";
export const MOVIE_BROWSEBY_FAIL = "MOVIE_BROWSEBY_FAIL";

// NEW: Admin Reply
export const ADMIN_REPLY_REVIEW_REQUEST = "ADMIN_REPLY_REVIEW_REQUEST";
export const ADMIN_REPLY_REVIEW_SUCCESS = "ADMIN_REPLY_REVIEW_SUCCESS";
export const ADMIN_REPLY_REVIEW_FAIL = "ADMIN_REPLY_REVIEW_FAIL";
export const ADMIN_REPLY_REVIEW_RESET = "ADMIN_REPLY_REVIEW_RESET";

// NEW: Latest Movies
export const MOVIES_LATEST_REQUEST = "MOVIES_LATEST_REQUEST";
export const MOVIES_LATEST_SUCCESS = "MOVIES_LATEST_SUCCESS";
export const MOVIES_LATEST_FAIL = "MOVIES_LATEST_FAIL";
