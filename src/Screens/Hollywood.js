...
function Hollywood() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load Hollywood titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="Hollywood Movies & Web Series | MovieFrost"
        description="Watch Hollywood and British English movies and web series online for free in HD. Latest Hollywood, British (English), and Hollywood Web Series (English)."
        keywords="Hollywood, British English, Hollywood Web Series, Movies, Web Series, Free HD Streaming"
        url="https://www.moviefrost.com/Hollywood"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">Hollywood</h1>
        ...
        {loading ? (
          ...
          <div className="w-full gap-6 flex-colo min-h-[50vh]">
            <Empty message="No Hollywood titles found" />
          </div>
        ) : (
          <>
