...
function Wrestling() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load Wrestling titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="Wrestling | MovieFrost"
        description="Watch WWE Wrestling content online for free in HD."
        keywords="WWE Wrestling, free HD streaming"
        url="https://www.moviefrost.com/Wrestling"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">Wrestling</h1>
        ...
        {loading ? (
          ...
          <div className="w-full gap-6 flex-colo min-h-[50vh]">
            <Empty message="No Wrestling titles found" />
          </div>
        ) : (
          <>
