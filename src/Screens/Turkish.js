...
function Turkish() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load Turkish titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="Turkish | MovieFrost"
        description="Watch Turkish movies and web series online for free in HD."
        keywords="Turkish movies, Turkish web series, free HD streaming"
        url="https://www.moviefrost.com/Turkish"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">Turkish</h1>
        ...
        {loading ? (
          ...
          <div className="w-full gap-6 flex-colo min-h-[50vh]">
            <Empty message="No Turkish titles found" />
          </div>
        ) : (
          <>
