...
function KoreanDrama() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load Korean Drama titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="Korean Drama | MovieFrost"
        description="Watch Korean drama movies & web series online for free in HD."
        keywords="Korean Drama, Korean TV shows, free HD streaming"
        url="https://www.moviefrost.com/korean-drama"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">Korean Drama</h1>
        ...
        {loading ? (
          ...
          <Empty message="No Korean Drama titles found" />
        ) : (
          <>
