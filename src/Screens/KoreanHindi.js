...
function KoreanHindi() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load Korean Hindi titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="Korean (Hindi Dubbed) | MovieFrost"
        description="Watch Korean Hindi dubbed movies and web series online for free in HD."
        keywords="Korean Hindi Dubbed, web series, free HD streaming"
        url="https://www.moviefrost.com/Korean-Hindi"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">Korean Hindi</h1>
        ...
        {loading ? (
          ...
          <div className="w-full gap-6 flex-colo min-h-[50vh]">
            <Empty message="No Korean Hindi titles found" />
          </div>
        ) : (
          <>
