...
function Punjabi() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load Punjabi titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="Punjabi | MovieFrost"
        description="Watch Indian Punjabi Movies & web series online for free in HD."
        keywords="Indian Punjabi Movies, Punjabi films, free HD streaming"
        url="https://www.moviefrost.com/Punjabi"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">Punjabi</h1>
        ...
        {loading ? (
          ...
          <div className="w-full gap-6 flex-colo min-h-[50vh]">
            <Empty message="No Punjabi titles found" />
          </div>
        ) : (
          <>
