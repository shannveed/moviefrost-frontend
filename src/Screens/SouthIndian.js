...
function SouthIndian() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load South Indian titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="South Indian | MovieFrost"
        description="Watch South Indian (Hindi Dubbed) movies and web series online for free in HD."
        keywords="South Indian movies Hindi Dubbed, free HD streaming"
        url="https://www.moviefrost.com/South-Indian"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">South Indian</h1>
        ...
        {loading ? (
          ...
          <div className="w-full gap-6 flex-colo min-h-[50vh]">
            <Empty message="No South Indian titles found" />
          </div>
        ) : (
          <>
