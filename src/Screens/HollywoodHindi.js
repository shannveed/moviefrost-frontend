...
function HollywoodHindi() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load Hollywood Hindi titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="Hollywood Hindi (Dubbed) | MovieFrost"
        description="Watch Hollywood Hindi dubbed movies and web series online for free in HD. Includes Hollywood (Hindi Dubbed) and Hollywood Web Series (Hindi Dubbed)."
        keywords="Hollywood Hindi, dubbed, web series, free HD streaming"
        url="https://www.moviefrost.com/Hollywood-Hindi"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">Hollywood Hindi</h1>
        ...
        {loading ? (
          ...
          <div className="w-full gap-6 flex-colo min-h-[50vh]">
            <Empty message="No Hollywood Hindi titles found" />
          </div>
        ) : (
          <>
