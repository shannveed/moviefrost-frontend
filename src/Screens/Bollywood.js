...
function Bollywood() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load Bollywood titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="Bollywood Movies & Web Series | MovieFrost"
        description="Watch Bollywood movies and web series online for free in HD. Includes Bollywood (Hindi), Bollywood Web Series (Hindi), Bollywood Web Series."
        keywords="Bollywood, Hindi, web series, free HD streaming"
        url="https://www.moviefrost.com/Bollywood"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">Bollywood</h1>
        ...
        {loading ? (
          ...
          <div className="w-full gap-6 flex-colo min-h-[50vh]">
            <Empty message="No Bollywood titles found" />
          </div>
        ) : (
          <>
