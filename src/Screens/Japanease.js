...
function Japanease() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setError(e?.message || 'Failed to load Japanease titles');
      } finally {
  ...
  return (
    <Layout>
      <MetaTags
        title="Japanese Movies & Web Series | MovieFrost"
        description="Watch Japanese movies and web series online for free in HD. Includes Japanese (Movies), Japanese Web Series, Japanese Web Series (Hindi)."
        keywords="Japanese movies, Japanese web series, free HD streaming"
        url="https://www.moviefrost.com/Japanease"
      />
      <div className="container mx-auto px-8 mobile:px-4 my-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-xl font-bold">Japanese</h1>
        ...
        {loading ? (
          ...
          <div className="w-full gap-6 flex-colo min-h-[50vh]">
            <Empty message="No Japanese titles found" />
          </div>
        ) : (
          <>
